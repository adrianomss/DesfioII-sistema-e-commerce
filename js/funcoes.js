...
function salvarForm() {
    if (typeof(Storage) !== "undefined") {
        ...
        cad = document.getElementById('nome').value + ';' + document.getElementById('email').value + ';' + document.getElementById('telefone').value + ';' + document.getElementById('senha').value;
        localStorage.setItem("cadastro_" + localStorage.cont, cad);
    }
}
//-----------------------------------------------------------------------------------------------------------
